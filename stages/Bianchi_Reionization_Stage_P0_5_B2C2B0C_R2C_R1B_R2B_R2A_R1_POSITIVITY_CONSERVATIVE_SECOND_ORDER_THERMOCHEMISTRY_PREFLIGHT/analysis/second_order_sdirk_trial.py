#!/usr/bin/env python3
"""MPRK22 chemistry coupled to an L-stable SDIRK2 thermal block."""
...
sdirk=_load('r2b_r2a_r1_sdirk_thermal_trial',HERE/'thermal_sdirk2.py')

class SecondOrderSDIRKTrial(base.SecondOrderPhysicalTrial):
